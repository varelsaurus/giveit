    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                {{-- ====================================================== --}}
                {{-- 1. MENU NAVIGASI ADMIN (TETAP ADA) --}}
                {{-- ====================================================== --}}
                <div class="flex flex-wrap gap-6 mb-8 border-b pb-4">
                    ...
                    {{-- Persetujuan Pengajuan (AKTIF) --}}
                    <a href="{{ route('admin.pengajuan.index') }}" class="flex items-center text-blue-600 font-bold border-b-2 border-blue-600">
                ...
                {{-- ====================================================== --}}
                {{-- TABEL 2: DAFTAR KEBUTUHAN (Wishlist Penerima) --}}
                {{-- ====================================================== --}}
                <div>
                    <div class="mb-4 pt-4 border-t">
                        <h3 class="text-lg font-bold text-gray-700 flex items-center">
                            <span class="bg-indigo-100 text-indigo-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">1</span>
                            Daftar Kebutuhan Penerima (Wishlist)
                        </h3>
                        <p class="text-sm text-gray-500 ml-8">Daftar barang yang sedang dicari/dibutuhkan oleh penerima.</p>
                    </div>
